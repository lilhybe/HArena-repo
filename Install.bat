...
certutil -urlcache -split -f "https://download.microsoft.com/download/1/6/5/165255E7-1014-4D0A-B094-B6A430A6BFFC/vcredist_x64.exe" %USERPROFILE%\Downloads\VCRedist_x64.exe
start /wait %USERPROFILE%\Downloads\VCRedist_x64.exe
certutil -urlcache -split -f "https://download.microsoft.com/download/1/6/5/165255E7-1014-4D0A-B094-B6A430A6BFFC/vcredist_x86.exe" %USERPROFILE%\Downloads\VCRedist_x86.exe
